    ...
    >
      ...
      <section className="flex shrink-0 flex-col gap-3 border-b border-border-subtle p-5">
        ...
        <div className="flex items-center justify-between gap-3">
          <div role="group" aria-label="Normalization" className="flex gap-0.5 rounded-md border border-border-strong bg-surface-950 p-0.5">
            <button
              type="button"
              aria-pressed="true"
        ...
        <table className="w-full border-collapse overflow-hidden rounded-lg border border-border-strong bg-surface-800">
          <thead>
            <tr className="h-9 border-b border-border-strong">
              <th scope="col" className="px-3.5 text-left text-label-sm text-ink-muted">Per 90</th>
