...
export function HomeShell() {
  ...
  const threadTitle =
    firstQuestion?.parts[0]?.type === "text"
      ? firstQuestion.parts[0].content
      : "New chat";

  const panelSourcePreview = (() => {
    const source = messages.find(
      (message) => message.id === panel.state.sourceMessageId,
    );
  ...
  const suggestedPrompts = [
    ...
    },
    {
      ...
      iconPath:
        "M10 4a3 3 0 1 1 0 6 3 3 0 0 1 0-6M4.5 16.5c0.8-3 3-4.5 5.5-4.5s4.7 1.5 5.5 4.5",
    ...
    <div className="flex h-dvh flex-col bg-surface-950">
      ...
      <div className="flex min-h-0 grow">
        ...
        <div className="flex min-h-0 grow flex-col">
          {hasThread && (
            <ThreadHeader title={threadTitle} messages={messages} />
          )}
          <div className="flex min-h-0 grow">
            {/* Main content area */}
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center-safe gap-8 px-12 pb-14">
                    ...
                    <div className="flex flex-col items-center gap-4 text-center w-full max-w-[760px]">
                      ...
                      <p className="text-body-lg max-w-[560px] text-ink-secondary">
                        Ask in plain words. Answers come back as numbers, charts
                        and match breakdowns you can open in detail.
                      </p>
                    </div>
                      ...
                      <div className="rounded-2xl border border-border-strong bg-surface-800 shadow-[0_0_0_6px_rgba(126,111,238,0.06),_0_24px_60px_rgba(2,3,5,0.6),_inset_0_1px_0_rgba(244,246,249,0.06)]">
                        ...
                        <div className="flex items-center gap-2 px-3 py-2.5 pl-4">
                          ...
                          <span className="text-body-sm text-ink-muted">
                            <kbd className="font-mono border border-border-strong px-1.5 rounded">
                              ⏎
                            </kbd>{" "}
                            to send
                          </span>
                  ...
                  <div className="flex-1 flex flex-col justify-end gap-6 px-4 pb-6">
                    ...
                    <div className="flex flex-col items-center gap-2 text-center">
                      ...
                      <h1 className="text-heading-md">
                        Ask anything about the tournament
                      </h1>
                      <p className="text-body-sm text-ink-secondary max-w-[300px]">
                        Teams, matches and players, answered with tournament
                        data.
                      </p>
                    </div>
